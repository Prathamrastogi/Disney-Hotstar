      ...
      <>
        <div className="">
          <div className="flex gap-2">
            <img src="/images/0.png" className="h-32" />
            <img src="/images/3.png" className="h-32" />
            <img src="/images/4.png" className="h-32" />
            <img src="/images/5.png" className="h-32" />
            <img src="/images/1.png" className="h-32" />
          </div>
        </div>
      </>
    );
